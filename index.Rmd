...
```{r}
ggplot(data=cbg_dv_march19, aes(geometry=geometry)) +
  geom_sf(aes(fill = dv_rate)) +
  theme_minimal() +
  ggtitle("DV rate by census block group in March 2019") +
  # theme(axis.line = element_blank(), axis.text = element_blank(),
  #       axis.ticks = element_blank(), axis.title = element_blank()) +
  scale_fill_viridis(option="inferno", direction = -1)

ggplot(data=cbg_dv_april19, aes(geometry=geometry)) +
  geom_sf(aes(fill = dv_rate)) +
  theme_minimal() +
  ggtitle("DV rate by census block group in April 2019") +
  theme(axis.line = element_blank(), axis.text = element_blank(),
        axis.ticks = element_blank(), axis.title = element_blank()) +
  scale_fill_viridis(option="inferno", direction = -1)
