...
```{r, fig.show='hold', fig.align='center', dpi=500}
map_dv_march19 <- ggplot(data=cbg_dv_march19, aes(geometry=geometry)) +
...
print(map_dv_march19)
print(map_dv_april19)
print(map_dv_march20)
print(map_dv_april20)
